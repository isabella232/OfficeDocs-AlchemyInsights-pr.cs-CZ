...
- Zkontrolujte [dokumentaci k Azure Information Protection(AIP),](https://docs.microsoft.com/azure/information-protection/what-is-information-protection) [požadavky na](https://docs.microsoft.com/azure/information-protection/get-started/requirements) nastavení a umístění a [stáhněte si klienta AIP](https://www.microsoft.com/download/details.aspx?id=53018).

- Informace o předplatném Azure najdete v [tématu Předplatná a funkce Azure Information Protection](https://azure.microsoft.com/pricing/details/information-protection).
