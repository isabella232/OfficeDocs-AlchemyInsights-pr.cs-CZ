...
1. Zadejte název a popis případu a klikněte na **Uložit.**
    > [!TIP]
    >Pokud chcete spravovat oprávnění pro tento případ, klikněte na mezeru vedle názvu případu (neklikejte na Otevřít).
1. Pokud chcete spravovat nastavení blokování, hledání a exportu pro tento případ, klikněte na **Otevřít.**

Podrobné informace o tom, jak případy eDiscovery pracují s obsahem, najdete v [případech eDiscovery.](https://go.microsoft.com/fwlink/?linkid=2101589)
