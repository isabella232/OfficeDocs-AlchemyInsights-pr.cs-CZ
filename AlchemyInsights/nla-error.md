...
ms.locfileid: "51035115"
---
# <a name="nla-error"></a>Chyba NLA

Podívejte se na následující článek, který vám pomůže vyřešit chyby ověřování nebo chyby NLA, ke kterým dochází při připojení pomocí protokolu RDP (Remote Desktop Protocol) k připojení k virtuálnímu počítači Azure:
