...
---
# <a name="webresource-visibility-property"></a>Webresource Viditelnost vlastnost

Musíte vybrat **možnost Viditelné ve výchozím nastavení,** aby se webový prostředek zobůvka zobrazila ve formuláři a byla dostupná uživatelům. Další informace najdete v [tématu Vlastnosti webových prostředků pro modelem řízené formuláře aplikací](https://docs.microsoft.com/powerapps/maker/model-driven-apps/web-resource-properties-legacy).