---
title: Import kontaktů na Outlook.com
ms.author: daeite
author: daeite
manager: joallard
ms.date: 04/21/2020
...
ms.locfileid: "53962196"
---
# <a name="import-contacts"></a>Import kontaktů

Před importem kontaktů na Outlook.com je budete muset exportovat od jiného poskytovatele e-mailu jako .csv souboru. Potom postupujte podle následujících pokynů.
...
.
2. V horní části stránky vyberte **Spravovat** \> **import kontaktů**.
3. Vyberte **Procházet,** přejděte do složky, do které jste uložili exportované kontakty, a vyberte **Otevřít.**

Další informace najdete v tématu [Import kontaktů do Outlook.com](https://support.office.com/article/285a3b55-8d93-4ac8-93df-43fffd13b2f1?wt.mc_id=Office_Outlook_com_Alchemy).
