...
2. Používání účtů **Nastavení**systému Windows  >  **Accounts**  >  **e-mailem & účty**, odebrání existujících pracovních účtů 
3. Používání účtů **Nastavení**systému Windows  >  **Accounts**  >  :**přístup k práci nebo škole**, odpojení existujících účtů 
...
5. Zkuste [obnovit](https://docs.microsoft.com/office365/troubleshoot/administration/connection-issue-when-sign-in-office-2016#symptom-2) chyby čipu TPM (Trusted Platform Module).