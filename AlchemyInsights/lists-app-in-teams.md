...
Tato funkce dodává výchozí nastavení. Seznamy jsou předinstalované pro všechny uživatele týmů a jsou dostupné přímo v galerii karet všech týmů a kanálů.  

Správci týmů můžou řídit dostupnost aplikace pomocí zásad oprávnění Microsoft Teams. Další informace najdete v článku [Správa zásad oprávnění aplikací v Microsoft Teams](https://docs.microsoft.com/microsoftteams/teams-app-permission-policies).
