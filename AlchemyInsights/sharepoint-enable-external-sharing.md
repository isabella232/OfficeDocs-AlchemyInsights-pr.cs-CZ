...
Další informace o externím sdílení (Guests) najdete v následujících odkazech.
...
- [Správa přístupu hostů ve skupinách Microsoft 365](https://docs.microsoft.com/microsoft-365/admin/create-groups/manage-guest-access-in-groups)
...
**Zobrazuje se chyba s externím uživatelem (host)?**

Zaškrtněte níže uvedené odkazy. 

- [Chyby při sdílení rozšíření na SharePointu nebo OneDrivu](https://docs.microsoft.com/sharepoint/sharepoint-onedrive-error-message)
