...
- [Blokování přístupu při zjištění rizika relace pomocí podmíněného přístupu k Azure Active Directory](https://docs.microsoft.com/azure/active-directory/conditional-access/app-sign-in-risk)